...
<?php
    ...
    // this function allows us to display the error message if needed
...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <title>Follow Through Form</title>
  </head>
    ...
    <div id="main-div">
      ...
      <main>
        ...
        <div id="secondary-div">
          ...
          <!--This is the form used to see if a participant followed through or not. The white text shows up on the page, and you are welcome to change the wording. You can copy-paste the form into ChatGPT if you want to understand it.-->
          <form
            method="POST"
