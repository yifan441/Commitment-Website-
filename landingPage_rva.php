...
// this stores the version when someone lands on this page, so we can put the version in the database later. 
session_start();
$_SESSION['landing'] = 'v1';
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    <main>
      <!--anywhere you see white text, it shows up on the page and can be changed to different wording.-->
      <section id="commit-section">
        ...
        <!--This is the button that leads to the sign-up page. To change the wording of the button, change the text inside value="" -->
        ...
        <div id="info-div">
          ...
          <ol>
            ...
            <li>
              ...
              <a href="landingPage_rva.php">precommit.us</a> to others.
            </li>
            <li>
      ...
      <section id="tac-section">
        <!--terms and conditions link. target="_blank" opens it in a new tab-->
